...
//-------------------------------
	...
	*pxTopOfStack = ( portSTACK_TYPE ) 0x00;	/* R0 */
	pxTopOfStack--;// No changes required to these lines of code
	...
	*pxTopOfStack = ( portSTACK_TYPE ) 0x23;	/* R23 */
	pxTopOfStack--;
	//No changes required to these registers, they are the same as the ATMega323

	/* Place the parameter on the stack in the expected location. */
	//This stuff should all be fine the way it is as well.
