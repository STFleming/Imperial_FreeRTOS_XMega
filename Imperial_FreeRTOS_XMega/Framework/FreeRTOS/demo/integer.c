...
//	xTaskCreate( vCompeteingIntMathTask1, "IntMath5", configMINIMAL_STACK_SIZE, ( void * ) &( usTaskCheck[ 4 ] ), uxPriority, NULL );
//	xTaskCreate( vCompeteingIntMathTask2, "IntMath6", configMINIMAL_STACK_SIZE, ( void * ) &( usTaskCheck[ 5 ] ), uxPriority, NULL );
//	xTaskCreate( vCompeteingIntMathTask3, "IntMath7", configMINIMAL_STACK_SIZE, ( void * ) &( usTaskCheck[ 6 ] ), uxPriority, NULL );
//	xTaskCreate( vCompeteingIntMathTask4, "IntMath8", configMINIMAL_STACK_SIZE, ( void * ) &( usTaskCheck[ 7 ] ), uxPriority, NULL );
}
/*-----------------------------------------------------------*/
...
portBASE_TYPE xReturn = pdTRUE, xTask;
	...
	for( xTask = 0; xTask < intgNUMBER_OF_TASKS; xTask++ )
	{
		if( usTaskCheck[ xTask ] == usLastTaskCheck[ xTask ] )
		{
			...
			xReturn = pdFALSE;
			lcd_putsp(PSTR("An Error Exists"));
		}
		else
		{
			lcd_putsp(PSTR("Peachy."));
		}
