/*
	...
	edited by Shane Fleming, Imperial College for use with the ATXMega128.
...
/* Changes made in ATXMega128 port, Stack size on called tasks is reduced. */
...
//LCD Include file
#include "sed1335.h"
//#include "print.h" //for the XMegaLab the LCD will be used to output messages.

/* Demo program include files. */
#include "integer.h"

#define intgSTACK_SIZE		( ( unsigned short ) 200 )
...
{
	//Used a smaller stack size for the ATXMega128.
	xTaskCreate( vCompeteingIntMathTask1, ( signed char * ) "IntMath1", intgSTACK_SIZE, ( void * ) &( usTaskCheck[ 0 ] ), uxPriority, NULL );
//	xTaskCreate( vCompeteingIntMathTask2, ( signed char * ) "IntMath2", intgSTACK_SIZE, ( void * ) &( usTaskCheck[ 1 ] ), uxPriority, NULL );
//	xTaskCreate( vCompeteingIntMathTask3, ( signed char * ) "IntMath3", intgSTACK_SIZE, ( void * ) &( usTaskCheck[ 2 ] ), uxPriority, NULL );
//	xTaskCreate( vCompeteingIntMathTask4, ( signed char * ) "IntMath4", intgSTACK_SIZE, ( void * ) &( usTaskCheck[ 3 ] ), uxPriority, NULL );
//	xTaskCreate( vCompeteingIntMathTask1, ( signed char * ) "IntMath5", intgSTACK_SIZE, ( void * ) &( usTaskCheck[ 4 ] ), uxPriority, NULL );
//	xTaskCreate( vCompeteingIntMathTask2, ( signed char * ) "IntMath6", intgSTACK_SIZE, ( void * ) &( usTaskCheck[ 5 ] ), uxPriority, NULL );
//	xTaskCreate( vCompeteingIntMathTask3, ( signed char * ) "IntMath7", intgSTACK_SIZE, ( void * ) &( usTaskCheck[ 6 ] ), uxPriority, NULL );
//	xTaskCreate( vCompeteingIntMathTask4, ( signed char * ) "IntMath8", intgSTACK_SIZE, ( void * ) &( usTaskCheck[ 7 ] ), uxPriority, NULL );
}
/*-----------------------------------------------------------*/
